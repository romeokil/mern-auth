...
function About() {
  ...
  <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
    <div class="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
      ...
      <form action="" class="mt-8 flex flex-col items-start space-x-2">
        <div>
        ...
        <div>
          <button
            type="button"
            class="rounded-md mt-5 bg-black px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Back to about Page
          </button>
        </div>
